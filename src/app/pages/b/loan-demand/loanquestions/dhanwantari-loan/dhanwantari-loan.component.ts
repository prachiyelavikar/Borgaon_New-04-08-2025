      ...
      if (this.data.PURPOSE_OF_LOAN == '2' || this.data.PURPOSE_OF_LOAN == '3') {
        ...
        if (this.data.PURPOSE_OF_LOAN == '3') {
          ...
          if (this.data.AVAILABILITY == 'C') {
            ...
            if (this.data.DATE_OF_QUOTATION[0] >= 0 && this.data.DATE_OF_QUOTATION[0] 
              <= 9 && this.data.DATE_OF_QUOTATION[1] >= 0 
              && this.data.DATE_OF_QUOTATION[1] <= 9 && 
              this.data.DATE_OF_QUOTATION[3] >= 0 && this.data.DATE_OF_QUOTATION[3] <= 9 && 
              this.data.DATE_OF_QUOTATION[4] >= 0 && this.data.DATE_OF_QUOTATION[4] <= 9 && 
              this.data.DATE_OF_QUOTATION[9] >= 0 && this.data.DATE_OF_QUOTATION[9] <= 9 && 
              this.data.DATE_OF_QUOTATION[8] >= 0 && this.data.DATE_OF_QUOTATION[8] <= 9 && 
              this.data.DATE_OF_QUOTATION[7] >= 0 && this.data.DATE_OF_QUOTATION[7] <= 9 && 
              this.data.DATE_OF_QUOTATION[6] >= 0 && this.data.DATE_OF_QUOTATION[6] <= 9) {
              ...
              if (this.converted <= new Date()) {
                this.data.DATE_OF_QUOTATION = this.datePipe.transform(this.converted, 'yyyy-MM-dd');
              } 
          }
          else {
            isOk = false;
        ...
        if (this.data.PURPOSE_OF_LOAN == '2' && this.data.TYPE == 'N') {
          ...
          isOk = false;
          this.message.error('Invalid Quotation Date','')
        }
