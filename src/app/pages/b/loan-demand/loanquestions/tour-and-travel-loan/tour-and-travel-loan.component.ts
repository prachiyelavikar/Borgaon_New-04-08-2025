...
export class TourAndTravelLoanComponent implements OnInit {
  ...
  save(): void {
    ...
    if (this.data.TRAVELLING_START_DATE[0] >= 0 && this.data.TRAVELLING_START_DATE[0] 
      <= 9 && this.data.TRAVELLING_START_DATE[1] >= 0 
      && this.data.TRAVELLING_START_DATE[1] <= 9 && 
      this.data.TRAVELLING_START_DATE[3] >= 0 && this.data.TRAVELLING_START_DATE[3] <= 9 && 
      this.data.TRAVELLING_START_DATE[4] >= 0 && this.data.TRAVELLING_START_DATE[4] <= 9 && 
      this.data.TRAVELLING_START_DATE[9] >= 0 && this.data.TRAVELLING_START_DATE[9] <= 9 && 
      this.data.TRAVELLING_START_DATE[8] >= 0 && this.data.TRAVELLING_START_DATE[8] <= 9 && 
      this.data.TRAVELLING_START_DATE[7] >= 0 && this.data.TRAVELLING_START_DATE[7] <= 9 && 
      this.data.TRAVELLING_START_DATE[6] >= 0 && this.data.TRAVELLING_START_DATE[6] <= 9) {
  
      var conformedPhoneNumber = conformToMask(
        this.data.TRAVELLING_START_DATE,
        this.mask,
        { guide: false }
      )
      ...
      if (this.converted <= new Date()) {
        this.data.TRAVELLING_START_DATE= this.datePipe.transform(this.converted, 'yyyy-MM-dd');
      } 
  }
  else {
    isOk = false;
    ...
    if (this.data.TRAVELLING_RETURN_DATE[0] >= 0 && this.data.TRAVELLING_RETURN_DATE[0] 
      <= 9 && this.data.TRAVELLING_RETURN_DATE[1] >= 0 
      && this.data.TRAVELLING_RETURN_DATE[1] <= 9 && 
      this.data.TRAVELLING_RETURN_DATE[3] >= 0 && this.data.TRAVELLING_RETURN_DATE[3] <= 9 && 
      this.data.TRAVELLING_RETURN_DATE[4] >= 0 && this.data.TRAVELLING_RETURN_DATE[4] <= 9 && 
      this.data.TRAVELLING_RETURN_DATE[9] >= 0 && this.data.TRAVELLING_RETURN_DATE[9] <= 9 && 
      this.data.TRAVELLING_RETURN_DATE[8] >= 0 && this.data.TRAVELLING_RETURN_DATE[8] <= 9 && 
      this.data.TRAVELLING_RETURN_DATE[7] >= 0 && this.data.TRAVELLING_RETURN_DATE[7] <= 9 && 
      this.data.TRAVELLING_RETURN_DATE[6] >= 0 && this.data.TRAVELLING_RETURN_DATE[6] <= 9) {
  
      var conformedPhoneNumber = conformToMask(
        this.data.TRAVELLING_RETURN_DATE,
        this.mask,
        { guide: false }
      )
      const str = conformedPhoneNumber.conformedValue.split('/');
      ...
      if (this.converted <= new Date()) {
        this.data.TRAVELLING_RETURN_DATE = this.datePipe.transform(this.converted, 'yyyy-MM-dd');
      } 
  }
  else {
    isOk = false;
