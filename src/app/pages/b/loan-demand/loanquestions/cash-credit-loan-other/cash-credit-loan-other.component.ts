...
export class CashCreditLoanOtherComponent implements OnInit {
  ...
  edit(data: WorkOrders, i: number): void {
    ...
    this.drawerData.START_DATE = this.datePipe.transform(this.drawerData.START_DATE, 'dd/MM/yyyy');
    this.drawerData.END_DATE = this.datePipe.transform(this.drawerData.END_DATE, 'dd/MM/yyyy');
    this.drawerVisible = true;
