...
@Component({
  selector: 'app-loantypewiseavgcount',
  templateUrl: './loantypewiseavgcount.component.html',
  styleUrls: ['./loantypewiseavgcount.component.css'],
  providers: [DatePipe]
})
export class LoantypewiseavgcountComponent implements OnInit {
