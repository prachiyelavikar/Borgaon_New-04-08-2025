...
@Component({
  selector: 'app-proposalamount',
  templateUrl: './proposalamount.component.html',
  styleUrls: ['./proposalamount.component.css'],
  providers: [DatePipe]
})
export class ProposalamountComponent implements OnInit {
