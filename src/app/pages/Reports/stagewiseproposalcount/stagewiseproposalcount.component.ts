...
@Component({
  selector: 'app-stagewiseproposalcount',
  templateUrl: './stagewiseproposalcount.component.html',
  styleUrls: ['./stagewiseproposalcount.component.css'],
  providers: [DatePipe]
})
export class StagewiseproposalcountComponent implements OnInit {
  ...
  search(reset: boolean = false) {
    ...
    this.dataList = []
    this.api.getBranchStageProposalcount(this.value1, this.value2, this.PROPOSAL_STAGE_ID.toString()).subscribe(data => {
