...
@Component({
  selector: 'app-stagewiseproposalamount',
  templateUrl: './stagewiseproposalamount.component.html',
  styleUrls: ['./stagewiseproposalamount.component.css'],
  providers: [DatePipe]
})
export class StagewiseproposalamountComponent implements OnInit {
  ...
  exportbutton = false;
  columns: string[][] = [['BRANCH_NAME', 'Branch Name'],  ['TOTAL', 'Total']]
  usertype = 'A';
  ...
  search(reset: boolean = false) {
    ...
    this.dataList = []
    this.api.getBranchStageProposalAmount(this.value1, this.value2, this.PROPOSAL_STAGE_ID.toString()).subscribe(data => {
