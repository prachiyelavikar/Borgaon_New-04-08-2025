...
@Component({
  selector: 'app-mylistforho1',
  templateUrl: './mylistforho1.component.html',
  styleUrls: ['./mylistforho1.component.css'],
  providers: [DatePipe]
})
export class Mylistforho1Component implements OnInit {
