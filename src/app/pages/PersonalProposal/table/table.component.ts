...
export class TableComponent implements OnInit {
  ...
  constructor(private api: ApiService, private message: NzNotificationService, private modal: NzModalService,private sanctionAmountService: SanctionAmountService) { }

  ngOnInit(): void {

    this.sanctionAmountService.updateMaturityDate(this.formattedEarliestMaturityDate());
  ...
  //     if (entry.INTEREST_RATE != null) {
  //       const interestRate = parseFloat(entry.INTEREST_RATE.toString());
  //       if (interestRate > highestInterestRate) { // Update highest interest rate
