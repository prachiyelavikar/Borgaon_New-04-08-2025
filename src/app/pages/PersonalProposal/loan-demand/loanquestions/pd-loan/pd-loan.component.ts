...
@Component({
  selector: 'app-pd-loan',
  templateUrl: './pd-loan.component.html',
  styleUrls: ['./pd-loan.component.css']
})


export class PDLoanComponent implements OnInit {
  data: pigmyDepositLoan = new pigmyDepositLoan();
  dataCode = 0
        ...
        this.api.updatedepositLoan(this.data)
          .subscribe(successCode => {
            if (successCode['code'] == "200") {
              ...
              this.logtext = 'Update & Close - pigmyDepositLoan form - SUCCESS ' + JSON.stringify(this.data) + " KEYWORD [U - pigmyDepositLoan ]";
              ...
              this.data = new pigmyDepositLoan()
              // this.demo.emit()
              this.getdata1();
        ...
        this.api.createdepositLoan(this.data)
          .subscribe(successCode => {
            if (successCode['code'] == "200") {
              ...
              this.logtext = 'Save & New - pigmyDepositLoan form - SUCCESS - ' + JSON.stringify(this.data) + " KEYWORD [C - pigmyDepositLoan ]";
              this.api.addLog('A', this.logtext, this.api.emailId)
                .subscribe(successCode => {
                  if (successCode['code'] == "200") {
                    //console.log(successCode);
              ...
              this.isButtonSpinning = false;
              this.logtext = 'Save & Close - pigmyDepositLoan form - ERROR - ' + JSON.stringify(this.data) + " KEYWORD [C - pigmyDepositLoan ]";
              this.api.addLog('A', this.logtext, this.api.emailId)
                .subscribe(successCode => {
                  if (successCode['code'] == "200") {
                    //console.log(successCode);
      ...
      successCode => {
        if (successCode['code'] == 200) {
          ...
          if (this.pigmyAccdata && this.pigmyAccdata.length > 0) {
            ...
            const interestRate: number = this.pigmyAccdata[0].INTEREST_RATE + 2;
