...
@Component({
  selector: 'app-business-goldloan-cc',
  templateUrl: './business-goldloan-cc.component.html',
  styleUrls: ['./business-goldloan-cc.component.css']
})

export class BusinessGoldloanCcComponent implements OnInit {
