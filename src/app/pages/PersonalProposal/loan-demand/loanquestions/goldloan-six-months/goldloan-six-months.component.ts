...
@Component({
  selector: 'app-goldloan-six-months',
  templateUrl: './goldloan-six-months.component.html',
  styleUrls: ['./goldloan-six-months.component.css']
})


export class GoldloanSixMonthsComponent implements OnInit {
