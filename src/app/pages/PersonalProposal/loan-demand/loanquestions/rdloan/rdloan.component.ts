...
// import { FRecurringDepositnew } from 'src/app/Models/PersonalProposal/FreccuringDepositnew';
...
export class reccurringDeposit{
...
@Component({
  selector: 'app-rdloan',
  templateUrl: './rdloan.component.html',
  styleUrls: ['./rdloan.component.css']
})
// export class RdloanComponent implements OnInit {
...
export class RdloanComponent implements OnInit {
  ...
  data: reccurringDeposit = new reccurringDeposit();
  dataCode = 0
        ...
        this.api.updatedepositLoan(this.data)
          .subscribe(successCode => {
            if (successCode['code'] == "200") {
              ...
              this.data = new reccurringDeposit()
              // this.demo.emit()
              this.getdata1();
      ...
      successCode => {
        if (successCode['code'] == 200) {
          ...
          if (this.recurringDepositdata && this.recurringDepositdata.length > 0) {
            ...
            const interestRate: number = this.recurringDepositdata[0].INTEREST_RATE + 2;
  ...
  totalIncome1() {
    let total6 = 0;
    console.log("im inthe totalincomedepo",this.recurringDepositdata)
  ...
  // averageInterest() {
  //   if (this.recurringDepositdata.length === 0) {
  //     return 0; // Handle the case when the array is empty to avoid division by zero
  //   }

  //   let totalInterest = 0;

  //   for (const entry of this.recurringDepositdata) {
  ...
  //   const average = totalInterest / this.recurringDepositdata.length;
