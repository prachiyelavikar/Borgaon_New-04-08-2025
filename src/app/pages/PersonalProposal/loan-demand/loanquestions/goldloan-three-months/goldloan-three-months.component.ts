...
@Component({
  selector: 'app-goldloan-three-months',
  templateUrl: './goldloan-three-months.component.html',
  styleUrls: ['./goldloan-three-months.component.css']
})


export class GoldloanThreeMonthsComponent implements OnInit {
