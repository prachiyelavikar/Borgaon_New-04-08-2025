...
@Component({
  selector: 'app-depositeccloan',
  templateUrl: './depositeccloan.component.html',
  styleUrls: ['./depositeccloan.component.css']
})


export class DepositeccloanComponent implements OnInit {
