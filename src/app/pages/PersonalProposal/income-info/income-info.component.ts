...
import { AgriInfoComponent } from '../agri-info/agri-info.component';
import { HouserentinfoComponent } from '../houserentinfo/houserentinfo.component';
import { IncomesalaryinfoComponent } from '../incomesalaryinfo/incomesalaryinfo.component';
import { AgricinfoComponent } from '../agricinfo/agricinfo.component';
import { ExpenditureinfoComponent } from '../expenditureinfo/expenditureinfo.component';
...
export class IncomeInfoComponent implements OnInit {
  ...
  @Input() data1: Incomeinformation = new Incomeinformation();
  ...
  @ViewChild(HouserentinfoComponent) House: HouserentinfoComponent;
  ...
  drawerTitle8: string;
  drawerTitle9: string;
  drawerData2: Otherinformation = new Otherinformation();
  ...
  // @Input() LOAN_KEY: Number;
  // @ViewChild(BusinessInfoComponent, { static: false }) buinessInfo: BusinessInfoComponent;
  // @ViewChild(AgriInfoComponent) otherInfo: AgriInfoComponent;
  // @ViewChild(HouserentinfoComponent) houseInfo: HouserentinfoComponent;
  // @ViewChild(IncomesalaryinfoComponent) salaryInfo: IncomesalaryinfoComponent;
  // @ViewChild(AgricinfoComponent) agricInfo: AgricinfoComponent;
  // @ViewChild(ExpenditureinfoComponent) expenditureInfo: ExpenditureinfoComponent;
  // browserLang = '';
  // formTitle = this.api.translate.instant('gincomeinfo.formTitle');
  // pageIndex = 1;
  // pageSize = 100;
    ...
    this.api.getAllIncomeSocurce(0, 0, this.sortKey, this.sortValue, " AND IS_ACTIVE = 1")
      .subscribe(data => {
        ...
        if (data['data'].length == 5) {
          ...
          for (let i = 0; i < this.incomeTypeData11.length; i++) {
            if (this.incomeTypeData11[i].ID == 3) {
              this.incomeTypeData11[i].ID = 4;
            }
            else if (this.incomeTypeData11[i].ID == 4) {
              this.incomeTypeData11[i].ID = 3;
            }
          }
        }
        console.log("Income data source", this.incomeTypeData11, "ok");
      ...
      .subscribe(data => {
        ...
        if (data['code'] == "200" && data['data'].length > 0) {
          ...
          this.checkOptionsOne = [
            { label: 'Salary', value: 'IS_SALARY', checked: this.data1.IS_SALARY ? true : false },
            { label: 'Business', value: 'IS_BUSINESS', checked: this.data1.IS_BUSINESS ? true : false },
            { label: 'Agriculture', value: 'IS_AGRICULTURE', checked: this.data1.IS_AGRICULTURE ? true : false },
            { label: 'House/Shop Rent', value: 'IS_HOUSE', checked: this.data1.IS_HOUSE ? true : false },
            { label: 'Other', value: 'IS_OTHER', checked: this.data1.IS_OTHER ? true : false },
            { label: 'No Income', value: 'IS_NO_INCOME', checked: this.data1.IS_NO_INCOME ? true : false },

          ];


          // this.getData3();  //SALARY
          this.getData4();  //BUSINESS 
          // this.getData5();  //AGRICULTURE
          // this.getData6();  //HOUSE
          this.getData55(); //EXPENDITURE
          // this.getData53(); //OTHER
          ...
          if (this.data1.IS_AGRICULTURE) {
            this.getData5();
          }

          if (this.data1.IS_HOUSE) {
            this.getData6();
          }
  ...
  // SALARY
  getData3() {
    this.api.getAllSalariedInformation(0, 0, this.sortKey, this.sortValue, ` AND INCOME_INFORMATION_ID = ${this.data1.ID} AND ARCHIVE_FLAG = 'F'`)
      .subscribe(data => {
  ...
  getData4() {
    ...
    this.api.getAllBusinessInformation(0, 0, 'ID', "asc", ` AND INCOME_INFORMATION_ID = ${this.data1.ID} AND ARCHIVE_FLAG = 'F'`)
  ...
  getData5() {
    ...
    this.dataList2 = [];
    let arr = []
    this.api.getAllAgricultureInformation(1, 20, 'ID', "asc", `AND INCOME_INFORMATION_ID = ${this.data1.ID} AND ARCHIVE_FLAG = 'F'`)
  ...
  getData53() {
    this.loadingRecords2 = true;
    this.dataList11 = []
    this.api.getAllOtherInformation(1, 20, 'ID', "asc", `AND INCOME_INFORMATION_ID = ${this.data1.ID} AND ARCHIVE_FLAG = 'F'`)
      .subscribe(successCode => {
        this.loadingRecords2 = false;
        if (successCode['code'] == 200) {
  ...
  getData55() {
    ...
    this.api.getAllExpenditureInformation(1, 20, 'ID', "asc", `AND INCOME_INFORMATION_ID = ${this.data1.ID} AND ARCHIVE_FLAG = 'F'`)
      .subscribe(successCode => {
        this.loadingRecords2 = false;
        if (successCode['code'] == 200) {
  ...
  getData6() {
    this.loadingRecords2 = true;
    // houserentinfo get
    this.api.getAllHouseRentInfo(1, 20, 'ID', "asc", `AND INCOME_INFORMATION_ID = ${this.data1.ID} AND ARCHIVE_FLAG = 'F'`)
      .subscribe(successCode => {
        this.loadingRecords2 = false;
        if (successCode['code'] == 200) {
  ...
  changeIncomeSource(incomeSourceId) {
    ...
    this.incomeTypeData2 = this.incomeTypeData11.filter((item) => item.ID !== this.data1.INCOME_SOURCE_ID || item.INCOME_SOURCE_ID == 6);
  ...
  changeOtherIncomeSource(otherincomeSourceId) {
    ...
    this.incomeTypeData3 = this.incomeTypeData11.filter((item) => item.ID !== this.data1.INCOME_SOURCE_ID && item.ID !== this.data1.OTHER_INCOME_SOURCE_ID || item.INCOME_SOURCE_ID == 6);
  ...
  changeOtherIncomeSource2(otherIncomeSourceId2) {
    ...
    this.incomeTypeData4 = this.incomeTypeData11.filter((item) => item.ID !== this.data1.INCOME_SOURCE_ID && item.ID !== this.data1.OTHER_INCOME_SOURCE_ID && item.ID !== this.data1.OTHER_INCOME_SOURCE_ID2 || item.INCOME_SOURCE_ID == 6);
  ...
  changeOtherIncomeSource4(otherIncomeSourceId3) {
    ...
    this.incomeTypeData5 = this.incomeTypeData11.filter((item) => item.ID !== this.data1.INCOME_SOURCE_ID && item.ID !== this.data1.OTHER_INCOME_SOURCE_ID && item.ID !== this.data1.OTHER_INCOME_SOURCE_ID2 && item.ID !== this.data1.OTHER_INCOME_SOURCE_ID3 || item.INCOME_SOURCE_ID == 6);
  ...
  deleteBusiness(data) {
    data.ARCHIVE_FLAG = 'T';
    this.api.updateBusinessFirmInformation(data).subscribe(res => {
      if (res['code'] == 200) {
        this.getData4();
      }
    });
  ...
  add2() {
    ...
    this.drawerData2 = new Otherinformation();
  ...
  deleteAgriculture(data) {
    data.ARCHIVE_FLAG = 'T';
    this.api.updateAgricultureLandInformation(data).subscribe(res => {
      if (res['code'] == 200) {
        this.getData5();
      }
    });
  ...
  edit2(agriii: Otherinformation): void {
  ...
  deleteOther(data) {
    data.ARCHIVE_FLAG = 'T';
    this.api.updateOtherInformation(data).subscribe(res => {
      if (res['code'] == 200) {
        this.getData53();
      }
    });
  ...
  edit25(data: any) {
    ...
    this.drawerTitle25 = 'House Info '
    this.drawerData25 = Object.assign({}, data);

    this.House.getaddressData(data.ADDRESS_ID);
    this.drawerVisible25 = true;
  ...
  deleteHouse(data) {
    data.ARCHIVE_FLAG = 'T';
    this.api.updateHouseRentInfo(data).subscribe(res => {
      if (res['code'] == 200) {
        this.getData6();
      }
    });
  ...
  deleteSalary(data) {
    data.ARCHIVE_FLAG = 'T';
    this.api.updateSalariedInformation(data).subscribe(res => {
      if (res['code'] == 200) {
        this.getData3();
      }
    });
  ...
  deleteExpenditure(data) {
    data.ARCHIVE_FLAG = 'T';
    this.api.updateExpenditureInformation(data).subscribe(res => {
      if (res['code'] == 200) {
        this.getData55();
      }
    });
  ...
  update() {
    ...
    // var isOk = true;
    // this.data1.INCOME_SOURCE_ID == 1 || this.data1.OTHER_INCOME_SOURCE_ID == 1 || this.data1.OTHER_INCOME_SOURCE_ID2 == 1
    // if (this.data1.IS_SALARY) {
  ...
  updateIncomeInformation() {
    if (this.data1.IS_SALARY || this.data1.IS_BUSINESS || this.data1.IS_AGRICULTURE || this.data1.IS_HOUSE || this.data1.IS_OTHER || this.data1.IS_NO_INCOME) {

      if (!this.data1.IS_NO_INCOME) {
      ...
      this.confirmModal = this.modal.confirm({
        ...
        nzOnOk: () =>
          new Promise((resolve, reject) => {
            ...
            //console.log(this.data1)
            this.data1.TYPE = "B"
            console.log("data1 Update Income", this.data1);
            if (this.data1.ID) {
  ...
  //   this.drawerTitle9 = "Add Expenditure Information"
  //   this.drawerData30 = new ExpenditureInfo();
  //   this.expenditureInfo.saveCount = 0;
  //   // this.HouseRentInfoData = new HouseRentInfo();
  //   this.drawerData30.INCOME_INFORMATION_ID = this.data1.ID;
  //   // this.drawerData3.TYPE = "B"
  //   // this.drawerData3.APPLICANT_ID = this.APPLICANT_ID
