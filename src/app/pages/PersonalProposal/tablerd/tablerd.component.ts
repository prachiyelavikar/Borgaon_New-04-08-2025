...
@Component({
  selector: 'app-tablerd',
  templateUrl: './tablerd.component.html',
  styleUrls: ['./tablerd.component.css']
})
export class TablerdComponent implements OnInit {
  index = -1;
  ...
  saveWorkdata1(): void {
    if (this.index > -1) {
      this.recurringDepositdata[this.index] = Object.assign({}, this.drawerData1);
    } else {
      this.recurringDepositdata.push(Object.assign({}, this.drawerData1));
    }
  ...
  //   // Iterate through recurringDepositdata and update the earliest maturity date
