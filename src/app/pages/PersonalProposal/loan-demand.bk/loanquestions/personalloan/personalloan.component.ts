...
export class PersonalloanComponent implements OnInit {
  ...
  save() {
    ...
    if (this.LOAN_SKIM_ID == 2 && this.questionies.IS_INSURANCE_TAKEN) {
      ...
      if (this.questionies.INSURANCE_POLICY_TAKEN_DATE == undefined || this.questionies.INSURANCE_POLICY_TAKEN_DATE == '') {
        isOk = false;
        this.message.error(this.api.translate.instant('personalloan.message3'), "");
      } else {
        this.questionies.INSURANCE_POLICY_TAKEN_DATE = this.pipe.transform(this.questionies.INSURANCE_POLICY_TAKEN_DATE, 'yyyy-MM-dd');
      }
      if (this.questionies.INSURANCE_POLICY_END_DATE == undefined || this.questionies.INSURANCE_POLICY_END_DATE == '') {
        isOk = false;
        this.message.error(this.api.translate.instant('personalloan.message4'), "");
      } else {
        this.questionies.INSURANCE_POLICY_END_DATE = this.pipe.transform(this.questionies.INSURANCE_POLICY_END_DATE, 'yyyy-MM-dd');
      }
