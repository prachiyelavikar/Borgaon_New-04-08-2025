...
export class BankLoanInfoComponent implements OnInit {
  ...
  //   this.data1.ACCOUNT_NUMBER = this.data1.ACCOUNT_NUMBER
  ...
  //   if (this.data1.DUE_DATE == undefined || this.data1.DUE_DATE == null)
  ...
  //     // else {
  //     //   isOk = false;
  //     //   this.message.error(this.api.translate.instant('basicinfo.dateerror'), "due date")
  //     // }
  //     // this.message.error(this.api.translate.instant('basicinfo.dateerror'), "due date")
  //   }

  //   if (this.data1.REPAYMENT_DATE == undefined || this.data1.REPAYMENT_DATE == '')
  //     this.data1.REPAYMENT_DATE = null;
  //   else {
  ...
  //     // else {
  //     //   isOk = false;
  //     //   this.message.error(this.api.translate.instant('basicinfo.dateerror'), "repayment date")
  //     // }

  //     // this.message.error(this.api.translate.instant('basicinfo.dateerror'), "repayment date")
  //   }

  //   if (this.data1.SANCTION_DATE == undefined || this.data1.SANCTION_DATE == null)
  //     this.data1.SANCTION_DATE = null;
  //   else {
  //     // if (this.data1.SANCTION_DATE[0] >= 0 && this.data1.SANCTION_DATE[0] <= 9 && this.data1.SANCTION_DATE[1] >= 0 && this.data1.SANCTION_DATE[1] <= 9 && this.data1.SANCTION_DATE[3] >= 0 && this.data1.SANCTION_DATE[3] <= 9 && this.data1.SANCTION_DATE[4] >= 0 && this.data1.SANCTION_DATE[4] <= 9 && this.data1.SANCTION_DATE[9] >= 0 && this.data1.SANCTION_DATE[9] <= 9 && this.data1.SANCTION_DATE[8] >= 0 && this.data1.SANCTION_DATE[8] <= 9 && this.data1.SANCTION_DATE[7] >= 0 && this.data1.SANCTION_DATE[7] <= 9 && this.data1.SANCTION_DATE[6] >= 0 && this.data1.SANCTION_DATE[6] <= 9) {

  //     //   var conformedPhoneNumber = conformToMask(
  //     //     this.data1.SANCTION_DATE,
  //     //     this.mask,
  //     //     { guide: false }
  //     //   )
  //     //   const str = conformedPhoneNumber.conformedValue.split('/');
  ...
  //     //   this.data1.SANCTION_DATE = this.datePipe.transform(this.converted, 'yyyy-MM-dd');

  //     // }
  //     // else {
  //     //   isOk = false;
  //     //   this.message.error(this.api.translate.instant('basicinfo.dateerror'), "sanction date")
  //     // }
  //   }
