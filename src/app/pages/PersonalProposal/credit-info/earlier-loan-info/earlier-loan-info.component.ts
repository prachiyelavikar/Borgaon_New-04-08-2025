...
export class EarlierLoanInfoComponent implements OnInit {
  ...
  //   if (this.data3.LOAN_TAKEN_DATE != undefined) {
  ...
  //   }
  //   else
  //     this.data3.LOAN_TAKEN_DATE = null
  ...
  //   if (this.data3.DUEDATE != undefined) {
  ...
  //   }
  //   else
  //     this.data3.DUEDATE = null;

  //   if (this.data3.REPAYMENT_DATE != undefined) {
  ...
  //   }
  //   else
  //     this.data3.REPAYMENT_DATE = null;
  ...
  //   if (ISOK) {
  //     if (this.data3.ID) {
  //       this.data3.ACCOUNT_NO= this.data3.ACCOUNT_NO
  ...
  save(addNew: boolean): void {
    ...
    var ISOK = true;
    this.isSpinning = true;
    console.log("value of purpose of loan1",this.data3.PURPOSE_OF_LOAN)
    ...
    if (this.data3.LOAN_AMOUNT == undefined)
      ...
      console.log("value of purpose of loan2",this.data3.PURPOSE_OF_LOAN)
