...
export class CreditInfoComponent implements OnInit {
  ...
  bank = 'Borgaon Urban Co-op Credit Society Ltd.,Borgaon (Multi-State)'
  isSpinning = false;
  isSpinning1 = false;
  checked = false;
  indeterminate = false;
  ...
  browserLang = 'en';
  @ViewChild(BankLoanInfoComponent) bankLoanInfo: BankLoanInfoComponent;
  @ViewChild(GuarantorForLoansInfoComponent) guarantorForloanInfo: GuarantorForLoansInfoComponent;

  @ViewChild(EarlierLoanInfoComponent) earlierLoanInfo: EarlierLoanInfoComponent;
  constructor(
  ...
  edit1(data: any): void {
    ...
    console.log("Edit 1 ", this.drawerData1);
