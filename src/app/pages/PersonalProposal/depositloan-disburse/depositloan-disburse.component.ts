...
@Component({
  selector: 'app-depositloan-disburse',
  templateUrl: './depositloan-disburse.component.html',
  styleUrls: ['./depositloan-disburse.component.css']
})
export class DepositloanDisburseComponent implements OnInit {
