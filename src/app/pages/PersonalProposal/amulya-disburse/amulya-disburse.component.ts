...
@Component({
  selector: 'app-amulya-disburse',
  templateUrl: './amulya-disburse.component.html',
  styleUrls: ['./amulya-disburse.component.css']
})
export class AmulyaDisburseComponent implements OnInit {
